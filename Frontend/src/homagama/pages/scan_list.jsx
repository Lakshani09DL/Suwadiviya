...
function HomagamaScanlist(){
    ...
    useEffect(() => {
        axios.get('http://127.0.0.1:8000/homagama/scans/homagama-scan-list')
        .then(response => {
    ...
    return(
        <>
            ...
            >
                Welcome to Scan Services at Homagama Base Hospital!
            </motion.h2>
            ...
            {selectedScan && (
                ...
                <div className="bg-white rounded-xl p-6 w-auto shadow-lg relative max-h-[80vh] overflow-y-auto">
                    <h3 className="text-2xl bg-blue-200 text-blue-800 font-semibold p-5 mt-20 mb-10">{selectedScan.name}</h3>
                    <div className="bg-slate-300 rounded-xl p-6 w-full max-w-full mx-auto">
                        ...
                        <p className="text-xl text-black font-semibold p-2 m-3">
                            <strong>Machine: </strong>{selectedScan.machine_name}
                        </p>
                        {/* <p className="text-xl text-black font-semibold p-2 m-3">
                        ...
                        <ul className="text-xl text-gray-800 font-semibold p-2 m-2">
                            {Object.entries(selectedScan.special_information).map(([key, value], index) => (
